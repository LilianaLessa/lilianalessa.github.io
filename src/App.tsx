...
export default function App() {
  ...
  return (
    ...
    >
      ...
      >
        Software Engineer · Distributed Systems · E-commerce
      </p>
      ...
      >
        My portfolio is currently being built. In the meantime, feel free to
        explore my work on GitHub or connect with me on LinkedIn.
      </p>
      ...
      <p
        className={visible ? "fade-up" : ""}
        style={{ ...delay(650), fontSize: "0.75rem", color: "#4b5563", marginTop: "1rem" }}
      >
        © 2026 Liliana Lessa
      </p>
    </div>
